...
- **Champions League Guessing Game**  
  Champions League Guessing Game was one of the most challenging and fun projects I have ever worked on. It was honestly the first project I felt excited about. I built a small web app in C++ that lets you guess the Champions League winner for a selected year. I used the Crow framework to handle HTTP requests and return a simple HTML page that I generated inside the C++ code. The project also required me to fix older Crow networking code so it would work with newer Boost versions in GitHub Codespaces. It helped me understand how C++ web servers work and how to send a basic UI from the backend without separate frontend files.
